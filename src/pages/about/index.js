          ...
          <div className="AboutPage-greeting">
            <AnimatedText
              messages={
                ...
                `Check it out!`,
                `This Sakura Tree is actually a program I wrote, which uses the pattern of recursion to generate and render a tree similar to the way that nature does it.`,
